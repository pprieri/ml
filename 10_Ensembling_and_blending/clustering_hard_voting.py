...
#B) With labels
#source: https://www.kaggle.com/code/akioonodera/tps-jul2022-bgmm/notebook
...
import math
list = pd.DataFrame(sortedObj[0:math.ceil(n_seed / 2)])[0]
...
preds = preds_mode.copy()
CPU times: user 41.1 s, sys: 169 ms, total: 41.3 s
Wall time: 41.2 s
